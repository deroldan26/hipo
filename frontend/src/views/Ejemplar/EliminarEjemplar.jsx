...
function EliminarEjemplar() {
    ...
    const verificarDatos = () =>{
        if((permisos.includes("Eliminar Ejemplar"))){
                    ...
                    <div className='col-4' style={{margin: 'auto'}}>
                        <div className='row'>
                            ...
                            <div className='col-5' style={{margin: 'auto'}}>
                                <button type="button" class="btn btn-outline-info">Buscar ID Ejemplar</button>
                            </div>
                        </div>
                        <div className="row">
...
export default EliminarEjemplar;