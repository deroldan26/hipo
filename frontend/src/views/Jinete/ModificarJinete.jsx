    ...
    return (
        <>
                ...
                <div className='container'>
                    <div className='col-4' style={{ margin: 'auto' }}>
                        ...
                        <div className='row'>
                            ...
                            <div className='col-5' style={{ margin: 'auto' }}>
                                <DatePicker placeholder="dd/m/yy"
                                    className="form__input"
                                />
                            </div>
                        </div>
                        ...
                        <div className="row">
                            <input type="text" name="Altura" id="Altura" className="form__input" placeholder="Altura" />
                        </div>
                        <div className="row">
                            <input type="text" name="Peso" id="Peso" className="form__input" placeholder="Peso" />
                        </div>
                        <div className="row">
                            <input type="text" name="Licencia" id="Licencia" className="form__input" placeholder="Numero de Licencia de Jinete" />
                        </div>
                        <div className="row">
            ...
            <div className="col-md-1" style={{
                ...
                <button type="button" className="boton" id='Volver' onClick={() => navigate("/ListaJinetes")}>Volver</button>
            </div>
            <p></p>
        </>
    );
...
export default ModificarJinete;