                    ...
                    <div className='col-4' style={{margin: 'auto'}}>
                        <div className='row'>
                            ...
                            <div className='col-5' style={{margin: 'auto'}}>
                                <button type="button" className="btn btn-outline-info">Buscar ID Caballeriza</button>
                            </div>
                        </div>
                        <div className="row">
...
export default EliminarCaballeriza;