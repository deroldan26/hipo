    ...
    return (
        <>
            ...
            <div style={{
                ...
                <h2>Modificar Caballeriza</h2>
            </div>
            <form control="" className="form-group">
                <div className='container'>
                    <div className='col-4' style={{ margin: 'auto' }}>
                        <div className="row">
                            <input type="text" name="Nombre" id="Nombre" className="form__input" placeholder="" />
                        </div>
                        <div className="row">
...
export default ModificarCaballeriza;